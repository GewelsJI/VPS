...
from utils.dataloader import get_pretrain_dataset, get_tmi_test_video_dataset
...
if __name__ == '__main__':
    ...
    config.save_path = config.save_path.replace('PNS_TMI_series', 'PNS_TMI_series_abla1')
    ...
    # load data
    print('load data...')
    train_loader =get_pretrain_dataset()
