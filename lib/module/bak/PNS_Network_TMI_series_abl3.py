...
class PNSNet(nn.Module):
    def __init__(self):
        ...
        self.NSB_local = NS_Block(32, radius=[3, 3], dilation=[1, 2], n_head=2, d_k=16, d_v=16)  # Window = 7, 13, 7, 13 / (16, 28)
        # self.NSB_local_2 = NS_Block(32, radius=[3, 3, 3, 3], dilation=[2, 3, 2, 3])  # Window = 19, 25, 19, 25/ (16, 28)
        print('Local: radius=[3, 3], dilation=[1, 2], n_head=2, d_k=16, d_v=16')
        # print('Local_2: radius=[3, 3, 3, 3], dilation=[2, 3, 2, 3]')
        
        print('Initializing NSB Series #3')
    ...
    def forward(self, x):
        if len(x.shape) == 4:  # Pretrain
            ...
            high_feature_1 = self.NSB_local(high_feature_local, high_feature_local)

            high_feature = high_feature_1 + high_feature_local
