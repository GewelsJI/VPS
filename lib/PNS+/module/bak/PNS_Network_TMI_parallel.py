...
class PNSNet(nn.Module):
    def __init__(self):
        ...
        print('Initializing NSB Parallel')
    ...
    def forward(self, x):
        if len(x.shape) == 4:  # Pretrain
            ...
            high_feature_global = self.NSB_global(high_feature_global, high_feature_local) + high_feature_local
            high_feature_local = self.NSB_local(high_feature_local, high_feature_local) + high_feature_local
