...
class PNSNet(nn.Module):
    def __init__(self):
        ...
        print('Local: radius=[3, 3, 3, 3], dilation=[2, 3, 2, 3]')
        print('Global: radius=[3, 3, 3, 3], dilation=[3, 4, 3, 4]')
        
        print('Initializing NSB Series #9')
    ...
    def forward(self, x):
        if len(x.shape) == 4:  # Pretrain
            ...
            high_feature_1 = self.NSB_local(high_feature_local, high_feature_local) + high_feature_local
            high_feature_2 = self.NSB_global(high_feature_global, high_feature_1) + high_feature_1
