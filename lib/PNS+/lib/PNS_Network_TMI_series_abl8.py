...
class PNSNet(nn.Module):
    def __init__(self):
        ...
        self.NSB_local_2 = NS_Block(32, radius=[3, 3, 3, 3], dilation=[1, 2, 1, 2])  # Window = 19, 25, 19, 25/ (16, 28)
        print('Local_1: radius=[3, 3, 3, 3], dilation=[2, 3, 2, 3]')
        print('Local_2: radius=[3, 3, 3, 3], dilation=[2, 3, 2, 3]')
        
        print('Initializing NSB Series #8')
    ...
    def forward(self, x):
        if len(x.shape) == 4:  # Pretrain
            ...
            high_feature_1 = self.NSB_local_1(high_feature_local, high_feature_local) + high_feature_local
            high_feature_2 = self.NSB_local_2(high_feature_1, high_feature_1) + high_feature_1
