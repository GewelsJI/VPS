...
class PNSNet(nn.Module):
    def __init__(self):
        ...
        self.NSB_local_1 = NS_Block(32, radius=[3, 3, 3, 3], dilation=[1, 2, 1, 2])  # Window = 7, 13, 7, 13 / (16, 28)
        self.NSB_global_1 = NS_Block(32, radius=[3, 3, 3, 3], dilation=[3, 4, 3, 4])  # Window = 19, 25, 19, 25/ (16, 28)
        self.NSB_local_2 = NS_Block(32, radius=[3, 3, 3, 3], dilation=[1, 2, 1, 2])  # Window = 7, 13, 7, 13 / (16, 28)
        self.NSB_global_2 = NS_Block(32, radius=[3, 3, 3, 3], dilation=[3, 4, 3, 4])  # Window = 19, 25, 19, 25/ (16, 28)
        
        print('Local: radius=[3, 3, 3, 3], dilation=[1, 2, 1, 2]')
        print('Global: radius=[3, 3, 3, 3], dilation=[3, 4, 3, 4]')
        
        print('Initializing NSB Series #11')
    ...
    def forward(self, x):
        if len(x.shape) == 4:  # Pretrain
            ...
            high_feature_1 = self.NSB_global_1(high_feature_global, high_feature_local) + high_feature_local
            high_feature_2 = self.NSB_local_1(high_feature_1, high_feature_1) + high_feature_1

            high_feature_3 = self.NSB_global_2(high_feature_global, high_feature_2) + high_feature_2
            high_feature_4 = self.NSB_local_2(high_feature_3, high_feature_3) + high_feature_3

            high_feature = high_feature_4 + high_feature_local
