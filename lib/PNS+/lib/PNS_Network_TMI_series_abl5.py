...
class PNSNet(nn.Module):
    def __init__(self):
        ...
        self.NSB_local = NS_Block(32, radius=[3, 3, 3, 3, 3, 3, 3, 3], dilation=[1, 2, 1, 2, 1, 2, 1, 2], n_head=8, d_k=4, d_v=4)  # Window = 7, 13, 7, 13 / (16, 28)
        # self.NSB_local_2 = NS_Block(32, radius=[3, 3, 3, 3], dilation=[2, 3, 2, 3])  # Window = 19, 25, 19, 25/ (16, 28)
        print('Local: radius=[3, 3, 3, 3, 3, 3, 3, 3], dilation=[1, 2, 1, 2, 1, 2, 1, 2], n_head=8, d_k=4, d_v=4')
        
        print('Initializing NSB Series #5')
