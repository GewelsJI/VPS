...
class PNSNet(nn.Module):
    def __init__(self):
        ...
        self.NSB_global_1 = NS_Block(32, radius=[3, 3, 3, 3], dilation=[3, 4, 3, 4])  # Window = 7, 13, 7, 13 / (16, 28)
        self.NSB_global_2 = NS_Block(32, radius=[3, 3, 3, 3], dilation=[3, 4, 3, 4])  # Window = 19, 25, 19, 25/ (16, 28)
        print('Global_1: radius=[3, 3, 3, 3], dilation=[3, 4, 3, 4]')
        print('Global_2: radius=[3, 3, 3, 3], dilation=[3, 4, 3, 4]')
        
        print('Initializing NSB Series #10')
    ...
    def forward(self, x):
        if len(x.shape) == 4:  # Pretrain
            ...
            high_feature_2 = self.NSB_global_2(high_feature_global, high_feature_1) + high_feature_1
