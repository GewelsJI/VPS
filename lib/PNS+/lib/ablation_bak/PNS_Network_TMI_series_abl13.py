...
class PNSNet(nn.Module):
    def __init__(self):
        ...
        self.NSB_local = NS_Block(32, radius=[3, 3, 3, 3], dilation=[3, 4, 3, 4])  # Window = 7, 13, 7, 13 / (16, 28)
        self.NSB_global = NS_Block(32, radius=[3, 3, 3, 3], dilation=[3, 4, 3, 4])  # Window = 19, 25, 19, 25/ (16, 28)
        print('Local: radius=[3, 3, 3, 3], dilation=[3, 4, 3, 4]')
        print('Global: radius=[3, 3, 3, 3], dilation=[3, 4, 3, 4]')

        print('Initializing NSB Series #13')
