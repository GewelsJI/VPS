...
from lib.PNS_Network_TMI_series_abl2 import PNSNet as Network
import torch
import numpy as np
...
if __name__ == "__main__":
    ...
    # at = AutoTest(["CVC-ClinicDB-612", "TestHardDataset"],  # , "TestHardDataset", "TestEasyDataset"
    #               config.video_testset_root,
    #               "snapshot/PNS_TMI_series_abla2/epoch_15/PNS_Finetune.pth")
    # at.test()
    at = AutoTest(["CVC-ColonDB-300", "TestEasyDataset"],  # , "TestHardDataset", "TestEasyDataset"
                  config.video_testset_root,
                  "snapshot/PNS_TMI_series_abla2/epoch_15/PNS_Finetune.pth")
    at.test()
